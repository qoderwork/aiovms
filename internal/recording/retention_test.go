...
func (m *mockRepoForRetention) FindByCamera(cameraID string) ([]model.Recording, error) {
	return nil, nil
}
...
func (m *mockRepoForRetention) CloseActiveSessionsByCamera(cameraID string, endTime time.Time) error {
	return nil
}
